...
export interface ApiCompanyProfileCompanyProfile
  ...
  attributes: {
    ...
    website: Schema.Attribute.String & Schema.Attribute.DefaultTo<'www.'>;
...
export interface ApiInnovatorInnovator extends Struct.CollectionTypeSchema {
  collectionName: 'innovators';
  info: {
    displayName: 'Innovator';
    pluralName: 'innovators';
    singularName: 'innovator';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::innovator.innovator'
    >;
    maturity: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    stage: Schema.Attribute.Enumeration<
      ['Beginner', 'Intermediate', 'Deployed']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
